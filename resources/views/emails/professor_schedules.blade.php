...
<p>Sesuai dengan jadwal yang sudah ditetapkan, berikut adalah jadwal mengajar</p>
...
padding-bottom: 5px; padding-left: 5px; padding-right: 5px; background: #5F9EA0; color: #FFFFFF; margin-left: 10%;"
    href="{{ $url }}">Click here to view all timetables</a>